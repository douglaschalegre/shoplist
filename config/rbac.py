...
from repositories.app import list_user as lu_repository, user as user_repository
...
def verify_user_access_to_list():
    ...
    def build_decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            user = user_repository.get_user_from_username(username=username, session=session)
            lu_repository.get_list_user(user_id=user.id, list_id=list_id, session=session)
